...
🎨 **Smart Colors** - AI suggests, you override  
...
python3 ~/.claude/skills/mondo-poster-prompt/scripts/generate_mondo_enhanced.py "Blade Runner" movie --ai-enhance

# 3-style comparison
python3 ~/.claude/skills/mondo-poster-prompt/scripts/generate_mondo_enhanced.py "Akira" movie --compare kilian-eng,saul-bass,jock

# Custom colors
python3 ~/.claude/skills/mondo-poster-prompt/scripts/generate_mondo_enhanced.py "Jazz Night" event --style milton-glaser --colors "orange, purple, yellow"

# Image-to-image
python3 ~/.claude/skills/mondo-poster-prompt/scripts/generate_mondo_enhanced.py "noir" movie --input poster.jpg --style saul-bass
